...
export class Select {
  ...
  private matchClick(e:any) {
    //console.log(`matchClick: e=${JSON.stringify(e, censor(e))}`);
    //e.preventDefault();
    if (this._disabled === true) {
      return;
    }
    ...
    if (this.inputMode === true && ((this.multiple === true && e) || this.multiple === false)) {
      this.focusToInput();
      this.open();
      //this.inputEvent(e); //Experiment remove
    }
  }

  private mainClick(e:any) {
    //console.log(`mainClick: e=${JSON.stringify(e, censor(e))} this=${JSON.stringify(this, censor(this))}`);
